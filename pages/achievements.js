...
export async function getStaticProps() {
  const res = await fetch(
    "http://ec2-34-215-195-143.us-west-2.compute.amazonaws.com:8080/api/v1/achievements/"
  );
  const json = await res.json();

  const fa = await fetch(
    "http://ec2-34-215-195-143.us-west-2.compute.amazonaws.com:8080/api/v1/faculty_achievements/"
  );
  const fa_json = await fa.json();

  const patent = await fetch(
    "http://ec2-34-215-195-143.us-west-2.compute.amazonaws.com:8080/api/v1/patents/"
  );
