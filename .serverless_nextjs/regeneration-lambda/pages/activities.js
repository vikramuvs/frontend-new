...
/* harmony import */ var next_dist_build_webpack_loaders_next_serverless_loader_page_handler__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(9436);
      ...
      const compMod = __webpack_require__(789)
...
__webpack_require__.d(__webpack_exports__, {
  "default": () => (/* binding */ pages_activities),
...
;// CONCATENATED MODULE: ./components/ActivitiesContent.js


function ActivitiesContent({ ivData , sswData , seoData , syllabus , timetable , studymaterial ,  }) {
                ...
                /*#__PURE__*/ (0,jsx_runtime.jsxs)("div", {
                    ...
                    children: [
                        /*#__PURE__*/ jsx_runtime.jsx("h2", {
                            ...
                            children: "Industry Visits"
                        }),
                        /*#__PURE__*/ jsx_runtime.jsx("br", {
                        }),
                        /*#__PURE__*/ jsx_runtime.jsx("div", {
                            className: "grid",
                            children: ivData.map((iv, i)=>{
                                return(/*#__PURE__*/ (0,jsx_runtime.jsxs)("div", {
                                    ...
                                    children: [
                                        /*#__PURE__*/ jsx_runtime.jsx("div", {
                                            ...
                                            children: iv.industry_visited
                                        }),
                                        /*#__PURE__*/ jsx_runtime.jsx("div", {
                                            className: "text-right text-black place-self-end flex-shrink text-lg",
                                            children: iv.date.substring(0, 10)
                                        })
                                    ]
                                }, iv.id));
                            })
                        ...
                        /*#__PURE__*/ jsx_runtime.jsx("h2", {
                            className: "text-2xl font-heading text-blue-ramaiah",
                            children: "Seminars/Worskshops"
                        }),
                        /*#__PURE__*/ jsx_runtime.jsx("br", {
                        }),
                        /*#__PURE__*/ jsx_runtime.jsx("div", {
                            className: "grid",
                            children: sswData.map((ssw, i)=>{
                                return(/*#__PURE__*/ (0,jsx_runtime.jsxs)("div", {
                                    className: "col-span-full bg-gray-deptHeader shadow-md flex p-2 border-b-[1px] border-pink-ramaiah",
                                    children: [
                                        /*#__PURE__*/ jsx_runtime.jsx("div", {
                                            className: "lg:min-w-[15%] lg:max-w-[15%]",
                                            children: ssw.duration_from
                                        }),
                                        /*#__PURE__*/ jsx_runtime.jsx("div", {
                                            className: "lg:min-w-[15%] lg:max-w-[15%]",
                                            children: ssw.duration_till
                                        }),
                                        /*#__PURE__*/ jsx_runtime.jsx("div", {
                                            className: "lg:min-w-[38%] lg:max-w-[38%] flex-grow",
                                            children: ssw.title
                                        }),
                                        /*#__PURE__*/ jsx_runtime.jsx("div", {
                                            className: "lg:min-w-[15%] lg:max-w-[15%] text-center",
                                            children: ssw.type
                                        }),
                                        /*#__PURE__*/ jsx_runtime.jsx("div", {
                                            className: "lg:min-w-[17%] lg:max-w-[17%] text-right",
                                            children: ssw.broad_area
                                        })
                                    ]
                                }, ssw.id));
                            })
                        ...
                        /*#__PURE__*/ jsx_runtime.jsx("h2", {
                            className: "text-2xl font-heading text-blue-ramaiah",
                            children: "Invited Talks / Guest Lectures"
                        }),
                        /*#__PURE__*/ jsx_runtime.jsx("br", {
                        }),
                        /*#__PURE__*/ jsx_runtime.jsx("div", {
                            className: "grid",
                            children: seoData.map((seo, i)=>{
                                return(/*#__PURE__*/ (0,jsx_runtime.jsxs)("div", {
                                    className: "col-span-full bg-gray-deptHeader shadow-md flex p-2 border-b-[1px] border-pink-ramaiah",
                                    children: [
                                        /*#__PURE__*/ jsx_runtime.jsx("div", {
                                        ...
                                        /*#__PURE__*/ jsx_runtime.jsx("div", {
                                            className: "lg:min-w-[20%] lg:max-w-[20%]",
                                            children: seo.name_of_the_scholar
                                        }),
                                        /*#__PURE__*/ jsx_runtime.jsx("div", {
                                            className: "lg:min-w-[30%] lg:max-w-[30%] text-center",
                                            children: seo.scholars_organization
                                        }),
                                        /*#__PURE__*/ jsx_runtime.jsx("div", {
                                            className: "lg:min-w-[35%] lg:max-w-[35%] text-right",
                                            children: seo.title_of_the_lecture
                                        })
                                    ]
                                }, seo.id));
                            })
...
;// CONCATENATED MODULE: ./pages/activities.js
...
function activities({ ind_visits , ssw_fdp , seo , sy , tt , sm , latestNews , latestEvents , deptStats ,  }) {
        ...
        children: [
            ...
            /*#__PURE__*/ (0,jsx_runtime.jsxs)("div", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ jsx_runtime.jsx(ActivitiesContent, {
                        ivData: ind_visits,
                        sswData: ssw_fdp,
                        seoData: seo,
                        syllabus: sy,
...
async function getStaticProps() {
    const iv = await fetch("http://ec2-34-215-195-143.us-west-2.compute.amazonaws.com:8080/api/v1/ind_visits/");
    const ivJson = await iv.json();
    const ssw = await fetch("http://ec2-34-215-195-143.us-west-2.compute.amazonaws.com:8080/api/v1/ssw_fdp/");
    const sswJson = await ssw.json();
    const seo = await fetch("http://ec2-34-215-195-143.us-west-2.compute.amazonaws.com:8080/api/v1/events_org/");
...
/* harmony default export */ const pages_activities = (activities);
...
var __webpack_exports__ = __webpack_require__.X(0, [146,959,52,193,616], () => (__webpack_exec__(7459)));
