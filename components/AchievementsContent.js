        ...
        <div className="col-span-full m-2 p-2 lg:col-start-4 lg:col-end-10 h-auto text-blue-ramaiah border-gray-100 border-2 bg-white">
          ...
          {pat.map((patent, i) => {
            return (
              <div
                key={patent.id}
                className="w-full border-gray-400 flex bg-gray-deptHeader space-x-2 shadow-md p-4 place-items-start border-[1px] mb-2"
              >
                <div className="">{patent.owner_name}</div>
                <div className="">{patent.patent_number}</div>
                <div className="">{patent.patent_title}</div>
